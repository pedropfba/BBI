...
## 13. Perguntas e respostas de apoio (24/09)

- **Uri (fev/2021, Texas/ERCOT):** frio extremo congelou poços e usinas. Houve ~20 GW de corte de carga, ~4,5 milhões de residências sem luz e 246 mortes (dado oficial do Texas). A produção de gás caiu pela metade, e o preço ficou dias no teto de US$ 9.000/MWh.
- **Elliott (dez/2022, PJM e Leste dos EUA):** ~46 GW de saídas forçadas no PJM (~25% da capacidade), **70% delas em usinas a gás** (falta de combustível, congelamento, falha de partida). As multas de *capacity performance* chegaram a **~US$ 1,8 bi**, 45% da receita de capacidade do ano. É o análogo mais próximo das penalidades do CRCAP.
- **Processo do leilão na ANEEL:** **48500.032821/2025-67** (Leilão nº 2/2026-ANEEL). Sobre a EPP: Nota Técnica nº 28/2026-CPL/ANEEL (SEI 0445783).
- **Condição para o CRCAP, usina conectada à malha:** termo de compromisso com a transportadora para contratar capacidade firme que sustente **≥70%** da operação a plena carga contínua, comprovado na ANP, por **7 anos + 5 anos** (ou o prazo remanescente do CRCAP).
- **Condição para o CRCAP, usina fora da malha (FSRU dedicado):** não há transportadora. Tem de comprovar na ANP o suprimento (GSA/SPA de GNL + acesso à regaseificação) que sustente os mesmos ≥70%. A distribuidora estadual continua sendo tema: gás canalizado é monopólio estadual (CF, art. 25, §2º), e o duto dedicado de autoimportador/autoprodutor (Lei 14.134) costuma exigir, conforme o estado, tarifa específica ou operação pela distribuidora.
- **Remanescentes:** são lances **válidos que não foram contratados** porque a demanda do produto foi preenchida por lances mais baratos. São convocados na ordem de classificação, **ao preço do próprio lance** (confirmar no edital). Eneva (790 MW) e Global (555 MW) cobrem ~1,3 dos ~1,7 GW da EPP e ficam ~400 MW sem contratar. A EPP caiu na **habilitação econômico-financeira** (PL mínimo de 10% do investimento).
- **Vaca Muerta / Uruguaiana:** o TGM (Aldea Brasilera–Uruguaiana) já existe. O trecho Uruguaiana–Porto Alegre (~593 km) só tem 25 km construídos em cada ponta. Sem ele, o gás que chega a Uruguaiana só serve a uma usina na própria fronteira. Riscos: inverno argentino (exportação interruptível justamente na seca brasileira) e ausência de GNL como alternativa no oeste do RS.
